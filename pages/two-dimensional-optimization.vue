...
import { type ExerciseVariant, type ExerciseVariantKey, variants } from '~/math/variants/two-dimentional-optimiazation-variants'
import { Method } from '~/math/two-dimentional-optimization'
import { useMethodParams } from '~/composables/two-dimentional-optimization'
...
useSeoMeta({
  ...
  description: 'Метод Ньютона',
  ogTitle: 'Методы двумерной оптимизации',
  ogDescription: 'Метод Ньютона',
})
